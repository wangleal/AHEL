...
import wang.leal.ahel.http.BuildConfig;
...
/**
 * Created by wang leal on 2017/6/1.
 */
...
public final class Utils {
    ...
    public static String md5(String msg){
        try
        {
            ...
            byte[] encryptions = md5.digest();
            StringBuilder strBul = new StringBuilder();
            for (byte encryption:encryptions) {
                if (Integer.toHexString(0xff & encryption).length() == 1)
                {
                    strBul.append("0").append(Integer.toHexString(0xff & encryption));
                }
                else
                {
                    strBul.append(Integer.toHexString(0xff & encryption));
                }
            }
    ...
    public static Type getParameterized(Type ownerType,Type rawType,Type... typeArguments){
        return new Utils.ParameterizedTypeImpl(ownerType,rawType,typeArguments);
    }
    ...
    public static Context checkNotInit(Context context){
        if (context == null){
            throw new RuntimeException("Please init the library via LibNet.init(Application)." +
                    "if it is init,please keep the application not be released,because wo have the WeakReference<Application>.");
        }
        return context;
    }
